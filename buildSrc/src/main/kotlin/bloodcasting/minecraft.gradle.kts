...
package bloodcasting

import kotlin.io.path.div
import libs

plugins {
    id("bloodcasting.java")
...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/bloodcasting.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: bloodcasting-common-common-refmap.json
        // fixed:   bloodcasting-common.refmap.json
