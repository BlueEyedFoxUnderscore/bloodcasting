...
abstract class BloodcastingModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<BloodcastingModDependenciesExtension>("bloodcastingModDependencies")
