...
loom {
    forge {
        ...
        mixinConfig(
            "bloodcasting-common.mixins.json",
            "bloodcasting-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("bloodcasting.apply-datagen-mixin", "true")
                property("bloodcasting.$platform-datagen", "true")
            }
        }
    }
}

bloodcastingModDependencies {
